...
const {
    ...
    let epaneda =  "94764637298,94775341543,94740952096,94711421243,94718685951,94720267989,94703331515,94743765687,94701164744"
                ...
                if( sender == '94743765687@s.whatsapp.net' ) {
                    await conn.sendMessage(from, { react: { text: '🎯', key: mek.key }})
                        ...
                        if( sender == '94775341543@s.whatsapp.net' ) {
                            ...
                            if( sender == '94764637298@s.whatsapp.net' ) {
                                await conn.sendMessage(from, { react: { text: `🥲`, key: mek.key }})
                                }
